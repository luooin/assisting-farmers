<template>
  <el-breadcrumb class="app-breadcrumb" separator="|" style="height:50px;backgroundColor:var(--publicMainColor);borderRadius:0px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:3px;borderColor:rgba(255, 255, 255, 1);">
