const style = {
	listStyle() {
		return { 
			...
			// "tableBtnDelBgColor": "var(--publicSubColor)", 
			"searchBtnIcon": "1", 
			"tableSize": "medium", 
			...
			"tableBtnIcon": "1", 
			"btnAdAllHeight": "auto", 
			// "btnAdAllWarnBgColor": "var(--publicSubColor)", 
			"btnAdAllBorderWidth": "15px", 
			"tableStripeFontColor": "#606266", 
			// "tableBtnBorderStyle": "dashed ", 
			"inputHeight": "40px", 
			// "btnAdAllBorderRadius": "20px",
			// "btnAdAllDelBgColor": "var(--publicSubColor)", 
			"pagePrevNext": true, 
			// "btnAdAllAddBgColor": "var(--publicSubColor)", 
			"searchBtnFont": "1", 
			"tableIndex": true, 
			"btnAdAllIcon": "1", 
			"tableSortable": false, 
			...
			// "tableBtnEditBgColor": "var(--publicSubColor)", 
			"box": { 
				"padding": "10px 20px", 
				"boxShadow": "0 0 6px rgba(0,0,0,0)", 
				"flag": "2", "backgroundImage": "", 
				"background": "#fff" 
			}, 
			...
			"inputFontColor": "#333", 
			"pageEachNum": 10, 
			"tableHeaderBgColor": "var(--publicSubColor)", 
			"inputTitleColor": "#333", 
			"btnAdAllBoxPosition": "1", 
			// "tableBtnDetailBgColor": "var(--publicSubColor)", 
			"inputIcon": "0", 
	...
	addStyle() {
		...
		return {
			...
			// "btnSaveBgColor": "var(--publicMainColor)",
			"uploadIconFontColor": "#8c939d",
			"textareaBorderColor": "#DCDFE6",
			"btnCancelBgColor": "var(--publicSubColor)",
